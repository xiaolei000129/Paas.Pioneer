...
namespace Paas.Pioneer.Domain.Shared.Extensions
{
	public static class ListExtensions
	{
		...
		/// <returns></returns>
		public static IEnumerable<T> ToTree<T>(this List<T> list, Func<T, T, bool> rootWhere, Func<T, T, bool> childsWhere, Action<T, IEnumerable<T>> addChilds, T entity = default)
		{
