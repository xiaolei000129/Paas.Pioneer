...
using Paas.Pioneer.Templates;
using Volo.Abp;
using Volo.Abp.EntityFrameworkCore;
using Volo.Abp.EntityFrameworkCore.Sqlite;
using Volo.Abp.Modularity;

namespace Paas.Pioneer.Template.EntityFrameworkCore.Tests.EntityFrameworkCore
{
    [DependsOn(
        typeof(TemplatesEntityFrameworkCoreModule),
        typeof(TemplatesTestBaseModule),
        typeof(AbpEntityFrameworkCoreSqliteModule)
        )]
    public class TemplatesEntityFrameworkCoreTestModule : AbpModule
    {
