...
{
    public class BaseExtensionsRepository<TEntity> : EfCoreRepository<WorkflowsDbContext, TEntity, Guid>, IBaseExtensionRepository<TEntity> where TEntity : Entity<Guid>, ISoftDelete
    {
        private readonly IDbContextProvider<WorkflowsDbContext> _dbContextProvider;

        public BaseExtensionsRepository(IDbContextProvider<WorkflowsDbContext> dbContextProvider)
