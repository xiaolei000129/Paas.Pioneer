...
namespace Paas.Pioneer.Workflow.HttpApi.Client
{
    [DependsOn(
        typeof(WorkflowsApplicationContractsModule),
        typeof(AbpTenantManagementHttpApiClientModule)
    )]
    public class WorkflowsHttpApiClientModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            var httpApiClientOptions = context.Services.ExecutePreConfiguredActions<WorkflowsServicesHttpApiClientOptions>();
            ...
            var allRefitServiceProxyTypes = new List<Type>(typeof(WorkflowsHttpApiClientModule).Assembly.GetTypes());
