...
using Paas.Pioneer.Hangfire.Domain.BaseExtensions;
...
namespace Paas.Pioneer.Hangfire.EntityFrameworkCore.BaseExtensions
{
    public class BaseExtensionsRepository<TEntity> : EfCoreRepository<HangfiresDbContext, TEntity, Guid>, IBaseExtensionRepository<TEntity> where TEntity : Entity<Guid>
    {
        private readonly IDbContextProvider<HangfiresDbContext> _dbContextProvider;

        public BaseExtensionsRepository(IDbContextProvider<HangfiresDbContext> dbContextProvider)
