...
namespace Paas.Pioneer.Admin.Core.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20220430100251_init_news")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Paas.Pioneer.Admin.Core.Domain.Comment.Information_CommentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex(new[] { "BusinessId" }, "IDX_BusinessId");

                    b.HasIndex(new[] { "ParentId" }, "IDX_ParentId")
                        .HasDatabaseName("IDX_ParentId1");

                    b.ToTable("Information_Comment");
            ...
            modelBuilder.Entity("Paas.Pioneer.Admin.Core.Domain.Grid.Information_GridEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Paas.Pioneer.Admin.Core.Domain.News.Information_NewsEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Paas.Pioneer.Admin.Core.Domain.Slideshow.Information_SlideshowEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.Property<int>("SlideshowType")
                        .HasColumnType("int")
                        .HasColumnName("SlideshowType")
                        .HasComment("轮播图类型");
                    ...
                    b.ToTable("Information_Slideshow");
