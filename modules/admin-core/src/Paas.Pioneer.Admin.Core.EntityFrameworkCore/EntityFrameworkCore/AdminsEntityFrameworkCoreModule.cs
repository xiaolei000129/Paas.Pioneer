...
namespace Paas.Pioneer.Admin.Core.EntityFrameworkCore.EntityFrameworkCore
{
    ...
    public class AdminsEntityFrameworkCoreModule : AbpModule
    {
        ...
        {
            context.Services.AddAbpDbContext<AdminsDbContext>(options =>
            {
            ...
            Configure<AbpDbContextOptions>(options =>
            {
                 ...
                 * See also AdminsMigrationsDbContextFactory for EF Core tooling. */
                options.UseMySQL();
            });
        }
    }
