...
{
    public class BaseExtensionsRepository<TEntity> : EfCoreRepository<AdminsDbContext, TEntity, Guid>, IBaseExtensionRepository<TEntity> where TEntity : Entity<Guid>, ISoftDelete
    {
        private readonly IDbContextProvider<AdminsDbContext> _dbContextProvider;

        public BaseExtensionsRepository(IDbContextProvider<AdminsDbContext> dbContextProvider)
