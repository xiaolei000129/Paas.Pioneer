...
{
    public class BaseExtensionsRepository<TEntity> : EfCoreRepository<MessagesDbContext, TEntity, Guid>, IBaseExtensionRepository<TEntity> where TEntity : Entity<Guid>, ISoftDelete
    {
        private readonly IDbContextProvider<MessagesDbContext> _dbContextProvider;

        public BaseExtensionsRepository(IDbContextProvider<MessagesDbContext> dbContextProvider)
