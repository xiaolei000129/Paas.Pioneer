...
namespace Paas.Pioneer.User.EntityFrameworkCore.BaseExtensions
{
    public class BaseExtensionsRepository<TEntity> : EfCoreRepository<UsersDbContext, TEntity, Guid>, IBaseExtensionRepository<TEntity> where TEntity : Entity<Guid>, ISoftDelete
    {
        private readonly IDbContextProvider<UsersDbContext> _dbContextProvider;

        public BaseExtensionsRepository(IDbContextProvider<UsersDbContext> dbContextProvider)
