...
namespace Paas.Pioneer.User.HttpApi.Client
{
    ...
    public class UsersHttpApiClientModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            var httpApiClientOptions = context.Services.ExecutePreConfiguredActions<UsersServicesHttpApiClientOptions>();
            ...
            var allRefitServiceProxyTypes = new List<Type>(typeof(UsersHttpApiClientModule).Assembly.GetTypes());
